    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {/* Month Indicator - Prominent */}
                <div className="bg-primary-50 dark:bg-primary-900/20 border-2 border-primary-200 dark:border-primary-800 p-4 rounded-lg mb-4">
                    <p className="text-center">
                        <span className="text-sm text-primary-700 dark:text-primary-400 block mb-1">Adding Utilities For:</span>
                        <span className="text-xl font-bold text-primary-900 dark:text-primary-300">
                            {new Date().toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}
                        </span>
                    </p>
                    <p className="text-xs text-primary-600 dark:text-primary-500 text-center mt-2">
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Water Bill (KSh)</label>
                    <input
                        type="number"
                        min="0"
                        value={values.water}
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Electricity Bill (KSh)</label>
                    <input
                        type="number"
                        min="0"
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Garbage Collection (KSh)</label>
                    <input
                        type="number"
                        min="0"
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Security (KSh)</label>
                    <input
                        type="number"
                        min="0"
