...
const PropertyCard = ({ property, onDelete }: { property: Property; onDelete: (id: string) => void }) => {
    ...
    return (
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-800 overflow-hidden hover:shadow-lg transition-shadow group">
            ...
            <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <p className="text-lg font-semibold text-gray-900 dark:text-gray-100">{property.units}</p>
                    </div>
                    <div>
                        <p className="text-xs text-gray-500 dark:text-gray-400">Occupancy</p>
                        <p className="text-lg font-semibold text-gray-900 dark:text-gray-100">{occupancyRate}%</p>
                    </div>
                    <div>
                        <p className="text-xs text-gray-500 dark:text-gray-400">Type</p>
                        <p className="text-sm font-medium text-gray-900 dark:text-gray-100 capitalize">{property.type}</p>
                    </div>
                    <div>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                    {property.amenities.slice(0, 3).map((amenity) => (
                        <span key={amenity} className="px-2 py-1 bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-gray-300 text-xs rounded">
                            {amenity}
                        </span>
                    ))}
                    {property.amenities.length > 3 && (
                        <span className="px-2 py-1 bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-gray-300 text-xs rounded">
                            +{property.amenities.length - 3} more
                        </span>
                    )}
                </div>

                <button className="w-full py-2 bg-primary-50 dark:bg-primary-900/20 text-primary-700 dark:text-primary-400 rounded-lg font-medium hover:bg-primary-100 dark:hover:bg-primary-900/30 transition-colors">
                    View Details
                </button>
            </div>
        </div>
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-1">Manage your rental properties</p>
                </div>
                <button
            ...
            <div className="bg-white dark:bg-slate-900 p-4 rounded-xl border border-gray-200 dark:border-slate-800">
                <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <select
                        ...
                        className="px-4 py-2 bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent text-gray-900 dark:text-white"
                    >
            ...
            >
                <form onSubmit={handleAddProperty} className="space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Property Image</label>
                        <input
                            type="file"
                            accept="image/*"
                    ...
                    <div className="border-t border-gray-200 dark:border-slate-700 pt-4 mt-4">
                        <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Payment Account Details (Optional)</h3>
                        <div className="space-y-3">
                            ...
                            <p className="text-xs text-gray-500">Tenants will see these details for bank transfers</p>
                        </div>
                    </div>
