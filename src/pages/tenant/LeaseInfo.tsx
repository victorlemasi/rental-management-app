    ...
    if (!tenant) {
        return (
            <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-200 dark:border-slate-800 p-12 text-center">
                <p className="text-gray-500 dark:text-gray-400 text-lg">No lease information found. Please contact management.</p>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-200 dark:border-slate-800 p-6">
                ...
                <div className="space-y-4">
                    <div className="flex justify-between items-center text-sm">
                        <span className="text-gray-600 dark:text-gray-400">Lease Progress</span>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-200 dark:border-slate-800">
                ...
                <div className="p-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                            <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-slate-800/50 rounded-lg">
                                <Home className="w-5 h-5 text-gray-600 dark:text-gray-400 mt-0.5" />
                                <div>
                                    <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Property</p>
                            ...
                            <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-slate-800/50 rounded-lg">
                                ...
                                <div>
                                    <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Unit Number</p>
                                    <p className="text-base font-semibold text-gray-900 dark:text-white">{tenant.unitNumber}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-slate-800/50 rounded-lg">
                                ...
                                <div>
                                    <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Lease Start</p>
                                    <p className="text-base font-semibold text-gray-900 dark:text-white">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-slate-800/50 rounded-lg">
                                <Calendar className="w-5 h-5 text-gray-600 dark:text-gray-400 mt-0.5" />
                                <div>
                                    <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Lease End</p>
                                    <p className="text-base font-semibold text-gray-900 dark:text-white">
                            ...
                            <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-slate-800/50 rounded-lg">
                                ...
                                <div>
                                    <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Monthly Rent</p>
                            ...
                            <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-slate-800/50 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-bold bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400 capitalize">
                                        {tenant.status}
                                    </span>
                                </div>
                            </div>
            ...
            {daysRemaining > 0 && daysRemaining <= 60 && (
                <div className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/30 dark:to-orange-900/30 border-2 border-yellow-300 dark:border-yellow-700 rounded-xl p-6 shadow-sm">
                    <div className="flex items-start gap-4">
                        <div className="bg-yellow-500 p-3 rounded-full">
                            <Calendar className="w-6 h-6 text-white" />
                        </div>
                        <div className="flex-1">
                            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Lease Renewal Notice</h3>
                            <p className="text-gray-700 dark:text-gray-300 mb-4">
                                Your lease is expiring in <span className="font-bold text-orange-600 dark:text-orange-400">{daysRemaining} days</span>.
