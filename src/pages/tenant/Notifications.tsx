            ...
            {notifications.length > 0 && (
                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                    ...
                    <div className="flex flex-wrap gap-2">
                        <button className="px-4 py-2 bg-white border-2 border-gray-300 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-100 transition-colors">
                            All ({notifications.length})
                        </button>
                        <button className="px-4 py-2 bg-white border-2 border-red-300 rounded-lg text-sm font-semibold text-red-700 hover:bg-red-50 transition-colors">
                            Urgent ({urgentCount})
                        </button>
                        <button className="px-4 py-2 bg-white border-2 border-orange-300 rounded-lg text-sm font-semibold text-orange-700 hover:bg-orange-50 transition-colors">
                            Warnings ({warningCount})
                        </button>
                        <button className="px-4 py-2 bg-white border-2 border-blue-300 rounded-lg text-sm font-semibold text-blue-700 hover:bg-blue-50 transition-colors">
                            Unread ({totalUnread})
                        </button>
                    </div>
                </div>
